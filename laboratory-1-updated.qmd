...
## BUILD TABLE
################
Measurements <- c("Sample mass (oven-dry)", "40s reading (uncorrected)", "Temperature (C)", "40s reading (corrected)", "% Sand", "2hr reading (uncorrected)", "Temperature @2hr (C)", "2hr reading (corrected)", "% Clay", "% Silt")
...
**Note**: In the table below, check one box to choose between the characteristics (gritty, smooth, or gritty/smooth). For ribbon length, choose between short (\<1"), medium (1-2"), or long (\>2").
