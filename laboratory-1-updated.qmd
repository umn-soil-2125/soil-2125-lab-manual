...
2.  After stirring, *carefully* and *slowly* insert the hydrometer (**the hydrometers are extremely fragile**) into the cylinder. Please refer to the figure on the next page. *Note*: you may need to use your finger to stop the hydrometer from bobbing.
...
$$
Sand (\%) = \frac{M_{sample,oven\ dry} - corrected\ 40s \ reading}{M_{sample,oven\ dry}} x 100\ ;\  Clay (\%) = \frac{corrected\ 2hr\ reading}{M_{sample,oven\ dry}} x 100\ ;\ Silt (\%) = 100 - (\% Sand + \% Clay)
$$
...
colnames(texturegrittysmooth) = c("Texture", "Dominated by gritty feel (Y/N)", "Dominated by smooth feel (Y/N)", "Equally gritty/smooth (Y/N)", "Ribbon length", "Textural Class Name")
