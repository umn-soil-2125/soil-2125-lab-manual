...
::: callout-note
##  Watch this video before you complete this investigation
```{r, echo = FALSE, message = FALSE, warning = FALSE, out.width = "25%"}
library(qrcode)

hydrometer_test_video <- qrcode::qr_code("https://youtube.com/watch?v=8Q3uqN-0rlU")
