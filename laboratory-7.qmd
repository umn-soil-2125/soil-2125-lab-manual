...
Observe the examples of physical weathering, then complete the table below. Record ONE POTENTIAL weathering process for each example and give a brief description of the process. Weathering processes can be reused.
...
3.  How might physical weathering help promote chemical weathering? $$\\[0.05in]$$
