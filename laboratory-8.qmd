...
1.  Match each soil profile with its location in Minnesota by the depth to CaCO~3~ (Bk or Ck). Mark the depth to effervescence in each case - use HCl to determine depths to carbonates. 1 inch on the monolith = 4 inches in real life.
