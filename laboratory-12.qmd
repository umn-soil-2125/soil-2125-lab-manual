...
R = Rainfall factor	C = Crop management factor
...
The tolerable soil loss for most soils in Minnesota is approximately 3 to 5 tons per acre per year. Which area(s) from Table 1 in Investigation A exceed T (circle one)?
